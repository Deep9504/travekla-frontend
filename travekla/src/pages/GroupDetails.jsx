...
const GroupDetails = () => {
  ...
  const handleAddPhoto = async () => {
    ...
    try {
        await fetch(`http://localhost:5000/api/groups/${group._id}/gallery`, {
            method: 'PUT',
  ...
  const handleSendChat = async () => {
    ...
    try {
        await fetch(`http://localhost:5000/api/groups/${group._id}/chat`, {
            method: 'POST',
            headers: {'Content-Type': 'application/json'},
  ...
  const handleSubmitReview = async () => {
    try {
        const res = await fetch(`http://localhost:5000/api/groups/${group._id}/reviews`, {
            method: 'POST',
            headers: {'Content-Type': 'application/json'},
